...
const searchContent = {
  english: {
    searchSection: {
      ...
      description: "We found available courses just for you.",
    ...
    contentSection: {
      heading: "Established",
      breadcrumbs: [
        { home: "Home", aboutUs: "About Us", mission: "Mission" },
        { home: "Home", aboutUs: "About Us", mission: "Mission" },
        { home: "Home", aboutUs: "About Us", mission: "Mission" },
      ],
      paragraphs: [
        "8/5/1994. The idea of establishing the King Abdullah University Hospital began with the idea of establishing the Jordan University of Science and Technology to be a center of excellence in providing high-quality health services and be a comprehensive transformational center locally and at the level of the Middle East.",
        "8/5/1994. The idea of establishing the King Abdullah University Hospital began with the idea of establishing the Jordan University of Science and Technology to be a center of excellence in providing high-quality health services and be a comprehensive transformational center locally and at the level of the Middle East.",
        "8/5/1994. The idea of establishing the King Abdullah University Hospital began with the idea of establishing the Jordan University of Science and Technology to be a center of excellence in providing high-quality health services and be a comprehensive transformational center locally and at the level of the Middle East.",
      ],
    },
  ...
  arabic: {
    searchSection: {
      title: "ابحث عن دوراتك",
      description: "وجدنا دورات متاحة خصيصًا لك.",
    ...
    contentSection: {
      heading: "تأسست",
      breadcrumbs: [
        { home: "الرئيسية", aboutUs: "معلومات عنا", mission: "المهمة" },
        { home: "الرئيسية", aboutUs: "معلومات عنا", mission: "المهمة" },
        { home: "الرئيسية", aboutUs: "معلومات عنا", mission: "المهمة" },
      ],
      paragraphs: [
        "8/5/1994. بدأت فكرة إنشاء مستشفى الملك عبدالله الجامعي بفكرة إنشاء جامعة العلوم والتكنولوجيا الأردنية لتكون مركزًا للتميز في تقديم خدمات صحية عالية الجودة وتكون مركزًا تحويليًا شاملاً محليًا وعلى مستوى الشرق الأوسط.",
        "8/5/1994. بدأت فكرة إنشاء مستشفى الملك عبدالله الجامعي بفكرة إنشاء جامعة العلوم والتكنولوجيا الأردنية لتكون مركزًا للتميز في تقديم خدمات صحية عالية الجودة وتكون مركزًا تحويليًا شاملاً محليًا وعلى مستوى الشرق الأوسط.",
        "8/5/1994. بدأت فكرة إنشاء مستشفى الملك عبدالله الجامعي بفكرة إنشاء جامعة العلوم والتكنولوجيا الأردنية لتكون مركزًا للتميز في تقديم خدمات صحية عالية الجودة وتكون مركزًا تحويليًا شاملاً محليًا وعلى مستوى الشرق الأوسط.",
      ],
    },
...
function UpdateContent(lang) {
  ...
  document.querySelector(".search-section .footer-title").textContent =
    searchContent[lang].searchSection.title;
  document.querySelector(".search-section .text-gray").textContent =
    searchContent[lang].searchSection.description;
  document.querySelector(".search-section .form-input").placeholder =
    searchContent[lang].searchSection.placeholder;
  document.querySelector(".search-section .btn-subscribe").textContent =
    searchContent[lang].searchSection.buttonText;

  // Update Content Section Heading
  document.querySelector(".content .big-text").textContent =
    searchContent[lang].contentSection.heading;

  // Update Breadcrumbs
  const breadcrumbElements = document.querySelectorAll(".content .breadcrumb");
  searchContent[lang].contentSection.breadcrumbs.forEach(
    (breadcrumb, index) => {
      if (breadcrumbElements[index]) {
        const links = breadcrumbElements[index].querySelectorAll("li a");
        const active = breadcrumbElements[index].querySelector("li.active");

        if (links.length >= 2 && active) {
          links[0].textContent = breadcrumb.home;
          links[1].textContent = breadcrumb.aboutUs;
          active.textContent = breadcrumb.mission;
        }
      }
    }
  );
  ...
  // Update Paragraphs
  const paragraphElements = document.querySelectorAll(".content p");
  searchContent[lang].contentSection.paragraphs.forEach((paragraph, index) => {
    if (paragraphElements[index]) {
      paragraphElements[index].textContent = paragraph;
    }
  });

...
const helpSectionContent = {
  english: {
    mainTitle: "Help and Support Center",
    subTitle: "What are you looking for?",
    searchPlaceholder: "Search for questions or articles",
    supportTitle: "Our Support Sections",
    supportDescription: "Read articles and questions",
    cards: [
      {
        title: "Payments",
        desc: "Learn about various payment methods, common issues that can arise, and how to resolve them.",
      },
      {
        title: "Account",
        desc: "Manage your account settings, update personal preferences, and learn how to recover your account in case of issues.",
      },
      {
        title: "General help",
        desc: "Find detailed answers to common questions related to our services, policies, and procedures.",
      },
      {
        title: "Shipping",
        desc: "Information on how shipping works, tracking your orders, and handling any delivery-related concerns.",
      },
      {
        title: "Refunds",
        desc: "Details on the refund process, eligibility criteria, and how to initiate a refund request.",
      },
      {
        title: "Reviews",
        desc: "Learn how to leave, edit, and manage product reviews, and understand the review system.",
      },
    ],
  },
  arabic: {
    mainTitle: "مركز المساعدة والدعم",
    subTitle: "ماذا تبحث عن؟",
    searchPlaceholder: "ابحث عن أسئلة أو مقالات",
    supportTitle: "أقسام الدعم لدينا",
    supportDescription:
      "اقرأ المقالات والأسئلة المتعلقة بالقضايا الشائعة، مثل المدفوعات، الشحن، المبالغ المستردة والمزيد.",
    cards: [
      {
        title: "المدفوعات",
        desc: "تعرف على طرق الدفع المختلفة، والمشكلات الشائعة التي قد تحدث، وكيفية حلها.",
      },
      {
        title: "الحساب",
        desc: "إدارة إعدادات حسابك، وتحديث التفضيلات الشخصية، وكيفية استرجاع حسابك في حال حدوث مشاكل.",
      },
      {
        title: "المساعدة العامة",
        desc: "اعثر على إجابات مفصلة للأسئلة الشائعة المتعلقة بخدماتنا، سياساتنا وإجراءاتنا.",
      },
      {
        title: "الشحن",
        desc: "معلومات حول كيفية عمل الشحن، تتبع طلباتك، وكيفية التعامل مع أي مشاكل تتعلق بالتوصيل.",
      },
      {
        title: "المبالغ المستردة",
        desc: "تفاصيل حول عملية استرداد المبالغ، معايير الأهلية، وكيفية تقديم طلب استرداد.",
      },
      {
        title: "التقييمات",
        desc: "تعرف على كيفية ترك التقييمات، تعديلها، وإدارتها، وفهم نظام التقييمات.",
      },
    ],
  },
};
...
function UpdateContent(lang) {
  ...
  const helpSection = helpSectionContent[lang];

  document.querySelector(".helpSection .titles h1").textContent =
    helpSection.mainTitle;
  document.querySelector(".helpSection .titles h3").textContent =
    helpSection.subTitle;
  document.querySelector(".helpSection .searchContainer input").placeholder =
    helpSection.searchPlaceholder;
  document.querySelector(".helpSection .main_title h2").textContent =
    helpSection.supportTitle;
  document.querySelector(".helpSection .main_title p").textContent =
    helpSection.supportDescription;

  const cards = document.querySelectorAll(".helpSection .card");

  cards.forEach((card, index) => {
    const cardContent = helpSection.cards[index];
    card.querySelector("h3").textContent = cardContent.title;
    card.querySelector("p").textContent = cardContent.desc;
    card.querySelector("p").style.textAlign =

...
const aboutContent = {
  ...
  arabic: {
    ...
    aboutUs: "من نحن",
    description:
      "لوريم ايبسوم هو نص شكلي يُستخدم في صناعات الطباعة والنشر. يتم وضع النص لتقديم نموذج لما سيكون عليه المحتوى الحقيقي.",
...
function UpdateContent(lang) {
  ...
  document.querySelector("#about-section .about-right h4").textContent =
    aboutContent[lang].ourStory;
  document.querySelector("#about-section .about-right h1").textContent =
    aboutContent[lang].aboutUs;
  document.querySelector("#about-section .about-right p").textContent =
    aboutContent[lang].description;

  const addressItems = document.querySelectorAll(
    "#about-section .address ul li"
  );

  addressItems[0].querySelector("p:nth-child(2)").textContent =
    aboutContent[lang].addressLabel;
  addressItems[0].querySelector("p:nth-child(4)").textContent =
    aboutContent[lang].address;

  addressItems[1].querySelector("p:nth-child(2)").textContent =
    aboutContent[lang].phoneLabel;
  addressItems[1].querySelector("p:nth-child(4)").textContent =
    aboutContent[lang].phone;

  addressItems[2].querySelector("p:nth-child(2)").textContent =
    aboutContent[lang].emailLabel;
  addressItems[2].querySelector("p:nth-child(4)").textContent =
    aboutContent[lang].email;
}

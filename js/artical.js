...
const mainContent = {
  english: {
    ...
    menu: [
      "<i class='fa-solid fa-chevron-right'></i> Article overview",
      "<i class='fa-solid fa-chevron-right'></i> Article objectives",
      "<i class='fa-solid fa-chevron-right'></i> Audience",
      "<i class='fa-solid fa-chevron-right'></i> FAQs",
      "<i class='fa-solid fa-chevron-right'></i> Testimonials",
      "<i class='fa-solid fa-chevron-right'></i> Gallery",
    ],
    rightContent: [
      "From skincare to makeup, our platform features a wide range of products that cater to all your beauty needs. We strive to provide our customers with a luxury shopping experience, from browsing through our carefully selected products to receiving them in our signature packaging. Shop with us for the ultimate in beauty luxury.",
      "From skincare to makeup, our platform features a wide range of products that cater to all your beauty needs. We strive to provide our customers with a luxury shopping experience, from browsing through our carefully selected products to receiving them in our signature packaging. Shop with us for the ultimate in beauty luxury.",
    ],
  },
  arabic: {
    ...
    shareText: "شارك مع:",
    menu: [
      "<i class='fa-solid fa-chevron-left'></i> نظرة عامة على المقال",
      "<i class='fa-solid fa-chevron-left'></i> أهداف المقال",
      "<i class='fa-solid fa-chevron-left'></i> الجمهور المستهدف",
      "<i class='fa-solid fa-chevron-left'></i> الأسئلة الشائعة",
      "<i class='fa-solid fa-chevron-left'></i> آراء العملاء",
      "<i class='fa-solid fa-chevron-left'></i> معرض الصور",
    ],
    rightContent: [
      "من العناية بالبشرة إلى المكياج، تقدم منصتنا مجموعة واسعة من المنتجات التي تلبي جميع احتياجات جمالك. نسعى لتقديم تجربة تسوق فاخرة لعملائنا، من تصفح منتجاتنا المختارة بعناية إلى استلامها بتغليفنا المميز. تسوق معنا لتجربة فاخرة لا تضاهى.",
      "من العناية بالبشرة إلى المكياج، تقدم منصتنا مجموعة واسعة من المنتجات التي تلبي جميع احتياجات جمالك. نسعى لتقديم تجربة تسوق فاخرة لعملائنا، من تصفح منتجاتنا المختارة بعناية إلى استلامها بتغليفنا المميز. تسوق معنا لتجربة فاخرة لا تضاهى.",
    ],
  },
};
...
function UpdateContent(lang) {
  ...
  // Update artical section
  // Update Title
  document.querySelector(".content-inner h1").textContent =
    mainContent[lang].title;

  // Update Share Section
  document.querySelector(".share-text").textContent =
    mainContent[lang].shareText;

  // Update Left Menu
  const menuItems = document.querySelectorAll(".menu-left .menu li a");
  menuItems.forEach((item, index) => {
    item.innerHTML = mainContent[lang].menu[index];
  });

  // Update Right Content
  const paragraphs = document.querySelectorAll(".content-right p");
  paragraphs.forEach((p, index) => {
    p.textContent = mainContent[lang].rightContent[index];
  });
}

...
// .section-accordion
const accordionContentTrans = {
  english: {
    accordion1: "What do you mean by Take Snacks 1?",
    accordion2: "What do you mean by Take Snacks 2?",
    accordion3: "What do you mean by Take Snacks 3?",
    accordion4: "What do you mean by Take Snacks 4?",
    accordion5: "What do you mean by Take Snacks 5?",
    accordion6: "What do you mean by Take Snacks 6?",
    accordion7: "What do you mean by Take Snacks 7?",
    accordion8: "What do you mean by Take Snacks 8?",
    accordion9: "What do you mean by Take Snacks 9?",
  },
  arabic: {
    accordion1: "هذا هو المحتوى العربي تيك سناكس  1.",
    accordion2: "هذا هو المحتوى العربي تيك سناكس  2.",
    accordion3: "هذا هو المحتوى العربي تيك سناكس  3.",
    accordion4: "هذا هو المحتوى العربي تيك سناكس  4.",
    accordion5: "هذا هو المحتوى العربي تيك سناكس  5.",
    accordion6: "هذا هو المحتوى العربي تيك سناكس  6.",
    accordion7: "هذا هو المحتوى العربي تيك سناكس  7.",
    accordion8: "هذا هو المحتوى العربي تيك سناكس  8.",
    accordion9: "هذا هو المحتوى العربي تيك سناكس  9.",
  },
};
...
function UpdateContent(lang) {
  ...
  // accordionContent
  // Update main title
  const mainTitle = document.querySelector(".section-accordion h1");
  mainTitle.textContent =
    lang === "arabic" ? "الأسئلة الشائعة" : "Frequently Asked Questions";
  ...
  accordions.forEach((accordion, index) => {
    ...
    title.textContent = accordionContentTrans[lang][key];
    description.textContent = accordionContentTrans[lang][key];
  });
}
...
accordionContent.forEach((item, index) => {
  let header = item.querySelector(".headerContainer");
...
window.addEventListener("click", (event) => {
  ...
  const isInsideAccordion = Array.from(accordionContent).some((accordion) =>
